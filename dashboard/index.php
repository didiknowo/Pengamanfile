...
<head>
    <title><?php echo $data['fullname']; ?> - Aplikasi Pengaman Surat</title>
    <meta charset="utf-8">
...
<body class="sidebar-mini fixed">
    ...
    <div class="content-wrapper">
        <div class="page-title">
            <div>
                <h1><i class="fa fa-home"></i> Aplikasi Pengaman Surat <b>(AES)</b></h1>
            </div>
            <div>
                <ul class="breadcrumb">
                        ...
                        <div class="row">
                           <!--  <div class="col-md-4">
                                <div class="widget-small warning"><i class="icon fa fa-users fa-3x"></i>
                                    <?php
                                    $query = mysqli_query($connect, "SELECT count(*) totaluser FROM users WHERE verifikasi = 'Ya'");
                            ...
                            <div class="col-md-6">
                                <div class="widget-small info"><i class="icon fa fa-key fa-3x"></i>
                                    <?php
        ...
        <!-- <div class="row">
      <div class="col-md-12">
        <div class="card" style="background-color: #D60000;">
          <div class="card-body">
