...
<body class="sidebar-mini fixed">
  ...
  <div class="content-wrapper">
    <div class="page-title">
      <div>
        <h1><i class="fa fa-file"></i> Kirim Berkas</h1>
      </div>
      <div>
        <ul class="breadcrumb">
          ...
          <div class="card-body">
            ...
            <fieldset>
              ...
              <div class="form-group">
                <label class="col-lg-2 control-label" for="inputFile">Email Tujuan</label>
                <div class="col-lg-4">
                  <input class="form-control" id="inputFile" placeholder="Email" type="email"
                  name="email" required>
                </div>
              </div>

              <div class="form-group">
                <label class="col-lg-2 control-label" for="inputFile">Subjek Pesan</label>
                <div class="col-lg-4">
                  <input class="form-control" id="inputFile" placeholder="Subjek" type="text"
                  name="subjek" required>
                </div>
              </div>

              <div class="form-group">
                <label class="col-lg-2 control-label" for="textArea">Isi Pesan</label>
                <div class="col-lg-4">
                  <textarea class="form-control" id="textArea" rows="3" name="pesan"
